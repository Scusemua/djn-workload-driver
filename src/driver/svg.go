...
const (
	cloudDisconnectedSVG = `<svg "width:%vpx;height:%vpx" viewBox="0 0 24 24" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
